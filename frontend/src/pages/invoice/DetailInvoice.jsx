...
const DetailInvoice = () => {
  ...
  const totalProductPrice = invoice?.infoProducts?.reduce(
    (sum, data) => (sum += data.price * data.quantity),
    0
  );
  const totalServicePrice = invoice?.infoServices?.reduce(
    (sum, data) => (sum += data.price * data.quantity),
    0
  );
          ...
          <Card bordered={false} className="mb-4">
            <Typography.Title level={4} className="mb-0">
              ...
              >
                ...
                <span>
                  {moneyRenderer(totalServicePrice + totalProductPrice)}
                </span>
              </Space>
            </Typography.Title>
          </Card>
